...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['btn-forgot'])) {
    ...
    if ($userData && mysqli_num_rows($userData) > 0) {
        ...
        require_once './mailpage/forgotPassword.php';
...
<body>
    <div class="container-fluid">
        <div class="container container-notlogin">
            <img src="Assets/illu/forgotpassword.png" loading="lazy" />
            <div class="mt-3 col-md-6 text-center">
                Take control of your account security by initiating the password reset through your registered email.
            </div>
            <div class="col-md-4 mt-3">
                <form method="post" class="mt-2">
                    <div class="form-group">
                        <input type="mail" class="input form-control" name="forgot-email"
